...
export class ListComponent implements OnInit {
  ...
  // Altera o campo usado para ordernar a listagem
  changeOrderField(field: string) {

    if (this.orderBy !== field) { // Se o campo selecioando é diferente do atual
  ...
  changeOrderDir(direction: any) {
    ...
    if (this.orderDr !== direction) { // Se o campo selecioando é diferente do atual
  ...
  deleteGame(gameKey, gameTitle) {
    ...
    // Mensagem para confirmar se deseja apagar (Observe a ! = NOT)
